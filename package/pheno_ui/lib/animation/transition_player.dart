...
class TransitionPlayer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Matrix4? transform;
    if (value['offset'] != null || value['rotation'] != null || value['scale'] != null) {
      ...
      if (rotation != null) {
        ...
        rotationM4.translate(screenSize.width * rotationAnchor.dx,
            screenSize.height * rotationAnchor.dy);
      ...
      if (scale != null) {
        ...
        scaleM4.translate(screenSize.width * scaleAnchor.dx,
            screenSize.height * scaleAnchor.dy);
        scaleM4.scale(scale);
        scaleM4.translate(-screenSize.width * scaleAnchor.dx,
            -screenSize.height * scaleAnchor.dy);
      }

      transform = translationM4 * rotationM4 * scaleM4;
    }
